...
var DATA2 = [
    { img: require('../assets/j1.jpg'), text: 'Fablous Stylish jean for men' },
    { img: require('../assets/j1.jpg'), text: 'Fablous Stylish jean for men' },
    { img: require('../assets/j1.jpg'), text: 'Fablous Stylish jean for men' },
    { img: require('../assets/j1.jpg'), text: 'Fablous Stylish jean for men' },
    { img: require('../assets/j1.jpg'), text: 'Fablous Stylish jean for men' },
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}>Jeans</Text>
                 </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <View style={{ marginTop: 10, justifyContent: 'center', marginLeft: 20 }}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('jeansD')}>
