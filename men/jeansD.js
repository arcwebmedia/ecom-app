...
class jeansD extends Component {
                ...
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: 'white' }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, backgroundColor: 'white' }} >
                            <Image style={{ height: 250, width: 200, }} source={require('../assets/j1.jpg')} />
                        </View>
                    ...
                    <View style={{ height: 100, backgroundColor: 'white', padding: 10, marginTop: 10, }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, width: '80%' }}>
                            <TouchableOpacity style={{
                                ...
                                <Text style={{ fontWeight: 'bold', color: 'black' }}>30</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{
                                ...
                                <Text style={{ fontWeight: 'bold', color: 'black' }}>32</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{
                                ...
                                <Text style={{ fontWeight: 'bold', color: 'black' }}>34</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{
                                ...
                                <Text style={{ fontWeight: 'bold', color: 'black' }}>36</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={{ height: 100, backgroundColor: 'white', padding: 10, marginTop: 10, marginBottom: 10 }}>
                        ...
                        <Text style={{ fontSize: 13, marginLeft: 10, color: 'black' }}>Fabric: Denim </Text>
                        <Text style={{ fontSize: 13, marginLeft: 10, color: 'black' }}>34(Waist Size :34in, Length:40 in) </Text>
...
export default connect(mapsStateToProps, mapsDispatchToProps)(jeansD)