...
var DATA2 = [
    { img: require('../assets/s1.png'), text: 'Classy Fashionable Men shirt' },
    { img: require('../assets/s1.png'), text: 'Classy Fashionable Men shirt' },
    { img: require('../assets/s1.png'), text: 'Classy Fashionable Men shirt' },
    { img: require('../assets/s1.png'), text: 'Classy Fashionable Men shirt' },
    { img: require('../assets/s1.png'), text: 'Classy Fashionable Men shirt' },
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}>Shirts</Text>
                 </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <View style={{ marginTop: 10, justifyContent: 'center', marginLeft: 20 }}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('shirtD')}>
                            <Image style={{ height: 150, width: 150, borderWidth: 1, borderColor: 'black' }} source={item.img} />
                             </TouchableOpacity>

                        <Text style={{marginTop: 10, color: 'black',fontSize:12 }}>{item.text}</Text>
