...
import { connect } from 'react-redux';
 ...
 class womenTshirts extends Component {
    constructor(props) {
        super(props);
        this.state = {
            categoryProduct:[],
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}> Women T-Shirts</Text>
                 </View>
...
const mapsStateToProps = (state) => {
  ...
  export default connect(mapsStateToProps, mapsDispatchToProps)(womenTshirts)
