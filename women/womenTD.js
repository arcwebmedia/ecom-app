...
class womenTD extends Component {
                ...
                <ScrollView>
                    <View style={{
                        ...
                        <View style={{ justifyContent: 'space-between', flexDirection: 'row', width: '40%' }}>
                            ...
                            <Text style={{ color: 'black', fontSize: 15, }}>WOMEN T-SHIRT</Text>
                        </View>
...
export default connect(mapsStateToProps,mapsDispatchToProps)(womenTD)