...
var DATA2 = [
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Jean' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Jean' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Jean' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Jean' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Jean' },
...
import { connect } from 'react-redux';
 ...
 class womenJeans extends Component {
    constructor(props) {
        super(props);
        this.state = {
            categoryProduct:[],
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}>WOMEN JEANS</Text>
                 </View>
...
const mapsStateToProps = (state) => {
  ...
  export default connect(mapsStateToProps, mapsDispatchToProps)(womenJeans)
