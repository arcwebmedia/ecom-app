...
class womenPD extends Component {
                ...
                <ScrollView>
                    <View style={{
                        ...
                        <View style={{ justifyContent: 'space-between', flexDirection: 'row', width: '40%' }}>
                            ...
                            <Text style={{ color: 'black', fontSize: 15, }}>WOMEN PLAZZO</Text>
                        </View>
...
export default connect(mapsStateToProps, mapsDispatchToProps)(womenPD)