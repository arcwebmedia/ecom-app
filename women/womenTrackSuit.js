...
var DATA2 = [
    { img: require('../assets/pic1.png'), text: ' Fashionable women Track Suit' },
    { img: require('../assets/pic1.png'), text: ' Fashionable women  Track Suit' },
    { img: require('../assets/pic1.png'), text: 'Fashionable women  Track Suit' },
    { img: require('../assets/pic1.png'), text: ' Fashionable women  Track Suit' },
    { img: require('../assets/pic1.png'), text: ' Fashionable women  Track Suit' },
...
import { connect } from 'react-redux';
 ...
 class womenTrackSuit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            categoryProduct:[],
    ...
    componentDidMount() {
        this.fetchByCategory("women")
    }

    async fetchByCategory(Women) {
        await fetch(`http://192.168.1.3:4001/api/v1/products?category=${Women}`, {
            method: "GET",
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}> Women Track Suit</Text>
                 </View>
...
const mapsStateToProps = (state) => {
  ...
  export default connect(mapsStateToProps, mapsDispatchToProps)(womenTrackSuit)
