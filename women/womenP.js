...
var DATA2 = [
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Plazzo' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women  Plazzo' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women  Plazzo' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women  Plazzo' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women  Plazzo' },
...
import { connect } from 'react-redux';
 ...
 export default class womenP extends Component {
    render() {
        return (
            <SafeAreaView style={{ flex: 1 }} >
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <View style={{ marginTop: 10, justifyContent: 'center', marginLeft: 20 }}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('womenPD')}>
