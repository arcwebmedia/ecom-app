...
class womenLD extends Component {
                ...
                <ScrollView>
                    <View style={{
                        ...
                        <View style={{ justifyContent: 'space-between', flexDirection: 'row', width: '40%' }}>
                            ...
                            <Text style={{ color: 'black', fontSize: 15, }}>WOMEN LEGGING</Text>
                        </View>
                    ...
                    <View style={{ backgroundColor: 'white' }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, backgroundColor: 'white' }} >
                            <Image style={{ height: 250, width: 200, }} source={require('../assets/pic.png')} />
                        </View>
                    ...
                    <View style={{ height: 150, backgroundColor: 'white', padding: 10, marginTop: 10, marginBottom: 10 }}>
                        ...
                        <Text style={{ fontSize: 13, marginLeft: 10, color: 'black' }}>Pattern:Self-Design</Text>
...
export default connect(mapsStateToProps,mapsDispatchToProps)(womenLD)