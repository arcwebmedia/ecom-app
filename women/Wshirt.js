...
var DATA2 = [
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women shirt' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women shirt' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women shirt' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women shirt' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women shirt' },
...
import { connect } from 'react-redux';
 ...
 export default class Wshirt  extends Component {
    render() {
        return (
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}> Women Shirts</Text>
                 </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <View style={{ marginTop: 10, justifyContent: 'center', marginLeft: 20 }}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('womenSD')}>
