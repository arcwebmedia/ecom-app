...
var DATA2 = [
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Top' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Top' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Top' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Top' },
    { img: require('../assets/pic1.png'), text: 'Classy Fashionable women Top' },
...
import { connect } from 'react-redux';
 ...
 class womenTop extends Component {
    constructor(props) {
        super(props);
        this.state = {
            categoryProduct:[],
            ...
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                 ...
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    ...
                    <Text style={{ color: 'black', fontSize: 15, }}> Women Top</Text>
                 </View>
...
const mapsStateToProps = (state) => {
  ...
  export default connect(mapsStateToProps, mapsDispatchToProps)(womenTop)
