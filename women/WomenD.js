...
class WomenD extends Component {
    constructor() {
        super();
        this.state = {
            clicked: 0,
                ...
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: 'white' }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, backgroundColor: 'white' }} >
                            <Image style={{ height: 250, width: 200, }} source={require('../assets/pic1.png')} />
                        </View>
...
export default connect(mapsStateToProps, mapsDispatchToProps)(WomenD)